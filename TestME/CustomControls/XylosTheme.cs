...
public class XylosTabControl : TabControl
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        checked
        {
            ...
            for (int i = 0; i <= num; i++)
            {
                ...
                string tag = "";
                if (!string.IsNullOrEmpty(Conversions.ToString(base.TabPages[i].Tag)))
                {
                    tag = Conversions.ToString(base.TabPages[i].Tag.ToString());
                }

                if (!tag.Equals("hide"))
                {
                    bool flag = !tag.Equals("header");
    ...
    protected override void OnSelecting(TabControlCancelEventArgs e)
    {
        ...
        if (flag)
        {
            ...
            string tag = "";
            if (!string.IsNullOrEmpty(Conversions.ToString(e.TabPage.Tag)))
            {
...
public class XylosTextBox : Control
{
    ...
    public int SelectionStart
    {
        ...
        set { this.TB.SelectionStart = value; }
    }
